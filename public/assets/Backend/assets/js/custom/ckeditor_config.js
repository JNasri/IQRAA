...
CKEDITOR.editorConfig = function( config ) {
    ...
    // CKEDITOR.plugins.addExternal( 'imageuploader', 'http://localhost/newtags/nt-portal/assets/Backend/bower_components/ckeditor/plugins/imageuploader/', 'imgbrowser.php' );
    // config.extraPlugins = 'filemanager';
    // config.filebrowserBrowseUrl = '../../../filebrowser/fm_ckeditor.html';
