        ...
        Selectize.define('dropdown_after', function(options) {
            this.positionDropdown = (function () {
                ...
                if(!isRtl) {
                    ...
                    this.$dropdown.css.right = position.right;
                }
                    ...
                    $thisCard
                        ...
                        .velocity(velPos, {
                            ...
                            begin: function(elements) {
                                ...
                                if($toolbar.length) {
                                    $toolbar.prepend('<span class="md-icon md-card-fullscreen-deactivate material-icons uk-float-left">'+backIcon+'</span>');
                                } else {
                                    $thisCard.append('<span class="md-icon md-card-fullscreen-deactivate material-icons uk-position-top-right" style="margin:'+backIconMargin+'">&#xE5CD;</span>')
                                }
                                altair_page_content.hide_content_sidebar();
                            }
                        }
        ...
        card_progress: function(card,percent,steps) {
            ...
            $toolbar_progress.each(function() {
                ...
                if(!isRtl) {
                    ...
                    $this.css({ 'background': '-moz-linear-gradient(right, '+bg_color+' '+bg_percent+'%, #fff '+(bg_percent)+'%)',});
                    $this.css({ 'background': 'linear-gradient(to left,  '+bg_color+' '+bg_percent+'%, #fff '+(bg_percent)+'%)'});
                    $this.css({ 'background': '-webkit-linear-gradient(right, '+bg_color+' '+bg_percent+'%, #fff '+(bg_percent)+'%)',});
    ...
    altair_helpers = {
        ...
        content_preloader_show: function(style,variant,container,width,height) {
            ...
            if(!$body.find('.content-preloader').length) {
                ...
                thisContainer.append('<div class="content-preloader content-preloader-'+variant+'" style="height:'+height+'px;width:'+width+'px;margin-right:-'+width/2+'px">' + preloader_content + '</div>');
                setTimeout(function() {
