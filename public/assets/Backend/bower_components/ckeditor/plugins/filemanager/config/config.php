<?php
$filemanager = include __DIR__.'/../../../../../../../application/config/filemanager.php';
...
$config = array(
	...
	*/
	...
	|
	*/
    'upload_dir' => $filemanager['upload_dir'],
    /*
    |--------------------------------------------------------------------------
	...
	*/
	...
	//**********************
	'ext_img'                                 => array( 'jpg', 'ico','jpeg', 'png', 'gif', 'bmp', 'tiff', 'svg' ), //Images
	'ext_file'                                => array( 'doc', 'ico', 'ico', 'docx', 'rtf', 'pdf', 'xls', 'xlsx', 'txt', 'csv', 'html', 'xhtml', 'psd', 'sql', 'log', 'fla', 'xml', 'ade', 'adp', 'mdb', 'accdb', 'ppt', 'pptx', 'odt', 'ots', 'ott', 'odb', 'odg', 'otp', 'otg', 'odf', 'ods', 'odp', 'css', 'ai', 'kmz','dwg', 'dxf', 'hpgl', 'plt', 'spl', 'step', 'stp', 'iges', 'igs', 'sat', 'cgm'), //Files
	'ext_video'                               => array( 'mov', 'ico', 'mpeg', 'm4v', 'mp4', 'avi', 'mpg', 'wma', "flv", "webm" ), //Video
	'ext_music'                               => array( 'mp3', 'ico', 'mpga', 'm4a', 'ac3', 'aiff', 'mid', 'ogg', 'wav' ), //Audio
	'ext_misc'                                => array( 'zip', 'ico', 'rar', 'gz', 'tar', 'iso', 'dmg' ), //Archives
